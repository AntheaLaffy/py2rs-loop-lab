...
description: "[DRAFT] 第 6 轮产品、CLI、UX 与运维人体工学审查。从用户和维护者视角检查恢复、批处理、缓存、错误可读性、配置、可访问性和 workflow；只产出报告。"
---
...
- The unit is usable through its intended public interface.
...
1. Confirm unit id and target audience.
...
```text
reviews/YYYY-MM-DD-<unit-id>-ergonomics.md
```
